...
int main (void) {
    ...
    cout << endl;
    cout << "Don't have that much money to buy food? How much money do you have?" << endl;
    cin >> Cash;
    if (Cash>3) {
        cout << "That's enough for an Ice Cap you ass! Go buy him one. Snippity Snap, you slave. Umm, I mean friend.";
    } else {
